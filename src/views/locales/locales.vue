    ...
    <div id="locales">
        ...
        <div  id="navigate-buttons" class="mlf">
           ...
           <div v-if="viewModal" class="modal_view">
            ...
            <h3 >¿Estás seguro de  <span>eliminar <br> esta local?</span></h3>
                </div>
...
import AddLcl from './addLcl.vue'
import EditLcl from './editLcl.vue'
export default {
  name: 'locales',
  components:{
   AddLcl,
      ...
      return response;
         ...
         includesItem(search, name){
          ...
          return name.includes(search)
           ...
           changeView(option, item){
             this.item=item
             this.setAddedLcl(item)
             this.setHistoryOptionLcl(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("locales/deleteItemLcl", {option: 'locales', id:id});
