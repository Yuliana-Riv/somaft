    ...
    <div id="oficinas">
        ...
        <div  id="navigate-buttons" class="mlf">
           ...
           <div v-if="viewModal" class="modal_view">
            ...
            <h3 >¿Estás seguro de  <span>eliminar <br> esta oficina?</span></h3>
                </div>
...
import AddOfn from './addOfn.vue'
import EditOfn from './editOfn.vue'
export default {
  name: 'oficinas',
  components:{
   AddOfn,
      ...
      return response;
         ...
         includesItem(search, name){
          ...
          return name.includes(search)
           ...
           changeView(option, item){
             this.item=item
             this.setAddedOfn(item)
             this.setHistoryOptionOfn(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("oficinas/deleteItemOfn", {option: 'oficinas', id:id});
