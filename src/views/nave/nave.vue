        ...
        <div tbl_content>
          <div v-if="data.length > 0">
            ...
            >
              ...
              <div class="tbl_item">
                <p>
                  <span v-if="item.estatus == 'INACTIVO'">oculto</span>
              ...
              <section class="dflx" v-if="identity.role !='colaborador'">
...
import AddNv from "./addNv.vue";
import EditNv from "./editNv.vue";
export default {
  name: "nave",
  components: {
    AddNv,
  ...
  methods: {
    ...
    changeView(option, item) {
      this.item = item;
      this.setAddedNv(item);
      this.setHistoryOptionNv(option);
    },
