    ...
    <div id="terrenos">
        ...
        <div  id="navigate-buttons" class="mlf">
           ...
           <div v-if="viewModal" class="modal_view">
            ...
            <h3 >¿Estás seguro de  <span>eliminar <br> este terreno?</span></h3>
                </div>
...
import AddTrr from './addTrr.vue'
import EditTrr from './editTrr.vue'
export default {
  name: 'terrenos',
  components:{
   AddTrr,
      ...
      return response;
         ...
         includesItem(search, name){
          ...
          return name.includes(search)
           ...
           changeView(option, item){
             this.item=item
             this.setAddedTrr(item)
             this.setHistoryOptionTrr(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("terrenos/deleteItemTrr", {option: 'terrenos', id:id});
