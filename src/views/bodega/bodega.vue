...
import AddBod from './addBod.vue'
import EditBod from './editBod.vue'
export default {
  name: 'bodega',
  components:{
   AddBod,
      ...
      return response;
         ...
         includesItem(search, name){
          ...
          return name.includes(search)
           ...
           changeView(option, item){
             this.item=item
             this.setAddedBod(item)
             this.setHistoryOptionBod(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("bodega/deleteItemBod", {option: 'bodega', id:id});
