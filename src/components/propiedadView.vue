<template>
  <div id="propiedad_view">
    ...
    <div class="pv_slider">
          ...
          <slide v-for="(item, index) in propiedad.fotos" :key="index">
            <div class="sl-pro">
              <img
                ...
                alt="foto propiedad"
                v-if="item.tipov == 'imagen'"
              />
              <div
                class="video-c"
                v-html="item.video_link"
                v-if="item.tipov == 'video'"
              ></div>
            </div>
      ...
      <div v-if="propiedad.propiedad == 'bodega'">
        <carousel :perPage="1" navigationEnabled>
          <slide v-for="(item, index) in propiedad.fotos" :key="index">
            <div class="sl-pro">
              <img
                class="pv_ft_prop"
                :src="url + 'bodega-img/' + item.image"
                alt="foto propiedad"
                v-if="item.tipov == 'imagen'"
              />
              <div
      ...
      <div v-if="propiedad.propiedad == 'otros'">
        <carousel :perPage="1" navigationEnabled>
          <slide v-for="(item, index) in propiedad.fotos" :key="index">
            <div class="sl-pro">
              <img
                class="pv_ft_prop"
                :src="url + 'otros-img/' + item.image"
                alt="foto propiedad"
                v-if="item.tipov == 'imagen'"
              />
              <div
      ...
      <div v-if="propiedad.propiedad == 'nave'">
        <carousel :perPage="1" navigationEnabled>
          <slide v-for="(item, index) in propiedad.fotos" :key="index">
            <div class="sl-pro">
              <img
                class="pv_ft_prop"
                :src="url + 'nave-img/' + item.image"
                alt="foto propiedad"
                v-if="item.tipov == 'imagen'"
              />
              <div
    ...
    <div class="pv_info">
      <div class="bx_pv_info">
        <img
          ...
          alt=""
        />
        <p class="prop_pre" v-if="propiedad.act_precio == 'ACTIVO'">
          ${{ propiedad.precio | formatCurrency }} <span>MXN</span>
        </p>
        <p class="prop_pre" v-else-if="propiedad.act_precio == 'INACTIVO'">
          {{ propiedad.leyenda }}
        </p>
        ...
        <div class="icons_bar">
          ...
          <div v-if="propiedad.propiedad == 'bodega'" class="pv_bar_prop">
            <img
              v-if="propiedad.estacionamiento"
              src="../assets/propiedades/carro.svg"
              alt="icono terreno"
            />
            <p v-if="propiedad.estacionamiento" class="mr1">
              {{ propiedad.estacionamiento }}
            </p>
            <img
              v-if="propiedad.superficie_bodega"
              src="../assets/propiedades/terreno.svg"
              alt="icono terreno"
            />
            <p v-if="propiedad.superficie_bodega" class="mr1">
              {{ propiedad.superficie_bodega }}
            </p>
            <img
              v-if="propiedad.superficie_oficina"
              src="../assets/propiedades/oficina.svg"
              alt="icono terreno"
            />
            <p v-if="propiedad.superficie_oficina" class="mr1">
              {{ propiedad.superficie_oficina }}
            </p>
          </div>
        </div>
        ...
        <div class="pv_foo">
          <div class="ft_ag">
            <img
              ...
              alt="foto agente"
              v-if="propiedad.colb_image !== null"
            />
          ...
          <a :href="'mailto:' + propiedad.colb_email">
...
.pv_det::-webkit-scrollbar {
  -webkit-appearance: none;
}

.pv_det::-webkit-scrollbar:vertical {
  width: 0.3645833333333333vw;
}

.pv_det::-webkit-scrollbar-button:increment,
.pv_det::-webkit-scrollbar-button {
  display: none;
}

.pv_det::-webkit-scrollbar:horizontal {
  height: 0.3645833333333333vw;
}

.pv_det::-webkit-scrollbar-thumb {
  background-color: #797979;
  /*border-radius: 1.0416666666666665VW;*/
  border: 0.10416666666666667vw solid #f1f2f3;
}

.pv_det::-webkit-scrollbar-track {
  border-radius: 0.3645833333333333vw;
}

#propiedad_view :deep(.video-c > .ql-video){
    width: 77.5vw;
    height: 58vw;
    pointer-events: all;
}
