    ...
    <div class="box-1">
      ...
      <div class="menu">
        <ul>
          ...
          <li
            class="submenu"
            :class="{ active: navOption == 'bodega' }"
            v-if="hidemenu2"
            @click="setOption('bodega'), setHistoryOptionBod('Default')"
          >
            &#10625; BODEGAS
          </li>
          ...
          <li
            class="submenu"
            :class="{ active: navOption == 'nave' }"
            v-if="hidemenu2"
            @click="setOption('nave'), setHistoryOptionNv('Default')"
          >
            &#10625; NAVES INDUSTRIALES
          </li>
          ...
          <li
            class="submenu"
            :class="{ active: navOption == 'otros' }"
            v-if="hidemenu2"
            @click="setOption('otros'), setHistoryOptionOtr('Default')"
          >
            &#10625; OTROS
          </li>
...
export default {
 ...
 ...mapActions("colaborador", ["getInfoByIdClb"]),
    ...
    ...mapActions("industrial", ["getInfoByIdInd"]),
    ...
    setOption: function (option) {
      ...
      if (option == "MenuP") {
        ...
        window.open("https://somainmobiliaria.com/", "_blank");
        ...
        this.getInfoByIdCss({
            id: this.identity.sub,
            option:"nave/colaborador"
          });
   
        }  else if (option == "bodega") {
          this.getInfoByIdOfn({
            id: this.identity.sub,
            option:"bodega/colaborador"
          });
        }  else if (option == "otros") {
          this.getInfoByIdOtr({
            id: this.identity.sub,
            option:"otros/colaborador"
          });
        }
